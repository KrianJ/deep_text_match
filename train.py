...
if __name__ == '__main__':
    ...
    if model_name == "drcn":
        p_c_index, h_c_index, p_w_index, h_w_index, same_word, y = load_all_data('./input/train.csv',
                                                                                 maxlen=params['input_shapes'][0][0])
        x = [p_c_index, h_c_index, p_w_index, h_w_index]
        y = keras.utils.to_categorical(y, num_classes=params['num_classes'])
        p_c_index_evl, h_c_index_evl, p_w_index_evl, h_w_index_evl, same_word_evl, y_eval = load_all_data(
            './input/dev.csv', maxlen=params['input_shapes'][0][0])
        ...
        p_c_index_test, h_c_index_test, p_w_index_test, h_w_index_test, same_word_test, y_test = load_all_data(
            './input/test.csv', maxlen=params['input_shapes'][0][0])
